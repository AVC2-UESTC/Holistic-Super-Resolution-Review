...
from .arch_util import CovpoolLayer, SqrtmLayer, default_conv, MeanShift, Upsampler
...
class SAN(nn.Module):
    def __init__(self, n_resgroups, n_resblocks, n_feats, reduction, scale, rgb_range, n_colors, res_scale, conv=default_conv):
